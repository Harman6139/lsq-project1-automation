...
\date{Updated through Jul 2026}

\begin{document}
\maketitle

\section*{Data \& Method}
The update uses 115 monthly LSQ observations from January 2017 through Jul 2026.
The original paper used 109 observations ending in January 2026; the added LSQ returns are Feb 2026 = 1.88\%, Mar 2026 = 3.68\%, Apr 2026 = 2.95\%, May 2026 = 7.64\%, Jun 2026 = 6.39\%, Jul 2026 = 3.39\%.
...
For 2026-07, the market comparators are calculated from Yahoo Finance daily adjusted closes at each month-end. The S\&P 500 TR return is -0.063493\%, and the NVIDIA return is 0.329853\%.
...
LSQ percent positive months & 95.40\% & 95.65\% & +0.25 pp \\
LSQ percent negative months & 4.60\% & 4.35\% & -0.25 pp \\
LSQ sample standard deviation & 4.06\% & 3.98\% & -0.08 pp \\
LSQ Sharpe ratio & 0.86 & 0.88 & +0.02 \\
LSQ Sortino ratio & 13.96 & 14.58 & +0.62 \\
LSQ Omega ratio & 88.28 & 94.26 & +5.98 \\
...
Percent Positive Months & 95.41 & 95.65 & +0.24 \\
Percent Negative Months & 4.59 & 4.35 & -0.24 \\
Average Positive Month & 3.68 & 3.72 & +0.04 \\
Average Negative Month & -0.87 & -0.87 & +0.00 \\
Standard Deviation & 4.06 & 3.98 & -0.08 \\
Sharpe Ratio & 0.86 & 0.88 & +0.02 \\
Sortino Ratio & 13.96 & 14.58 & +0.62 \\
Omega Ratio & 88.28 & 94.26 & +5.98 \\
\bottomrule
\end{tabular}
\end{center}
\normalsize
...
The updated LSQ statistics move only moderately because 6 months are being added to a 109-month sample.
The added sample contains 6 positive months and 0 negative months, leaving 110 positive months and 5 negative months in total.
The average monthly return rises relative to the paper after incorporating returns through Jul 2026.
...
The Sharpe ratio is 0.88, the Sortino ratio is 14.58, and the zero-threshold Omega ratio is 94.26.
...
S\&P 500 TR & -0.14 & 0.1278 & 0.4457 & 0.3067 \\
LSQ minus S\&P 500 TR & 0.01 & 0.8735 & 0.9787 & 0.8799 \\
\bottomrule
\end{tabular}
...
\midrule
LSQ monthly mean & 3.52\% & 0.37\% & 9.47 & 0.52\% & 6.71 \\
Monthly alpha & 3.55\% & 0.39\% & 9.15 & 0.58\% & 6.13 \\
...
\footnotesize
Newey-West standard errors use 4 monthly lags, based on the rule $\lfloor 4(T/100)^{2/9}\rfloor$ with $T=115$.
